    ...
    return (
        <div className="min-h-screen flex flex-col bg-white dark:bg-black font-sans text-gray-900 dark:text-gray-100 overflow-x-hidden selection:bg-emerald-500/30">
            ...
            <div className="fixed inset-0 pointer-events-none z-0">
                <div className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] bg-green-100/40 dark:bg-emerald-900/10 rounded-full blur-[100px]"></div>
                <div className="absolute top-[20%] right-[-10%] w-[40%] h-[60%] bg-teal-50/40 dark:bg-teal-900/10 rounded-full blur-[120px]"></div>
            </div>
                ...
                <section className="py-24 px-4 relative transition-colors duration-300">
                    ...
                    <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-6 relative z-10">
                        {[
                            ...
                            { icon: <PremiumContextAwareIcon />, title: "Universal & Context Aware", desc: "Dynamically adopts the persona of any profession (Medical, Engineering, Sales, etc.) by deeply analyzing your CV and Job Description.", badge: "INTELLIGENCE", badgeClass: "bg-green-100 text-green-900", shadowClass: "shadow-[0_15px_40px_-15px_rgba(34,197,94,0.3)] dark:shadow-[0_15px_40px_-15px_rgba(34,197,94,0.15)]", glowColor: "bg-green-500" },
